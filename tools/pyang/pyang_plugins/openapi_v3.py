...
def pyang_plugin_init():
    plugin.register_plugin(OpenApiV3Plugin())
...
class OpenApiV3Plugin(plugin.PyangPlugin):
    ...
    def add_opts(self, optparser):
        optlist = [
            optparse.make_option("--outputdir",
                                 type="string",
                                 dest="outdir",
                                 help="Output directory for specs"),
            optparse.make_option("--md-outputdir",
                                 type="string",
                                 dest="mdoutdir",
                                 help="Output directory for markdown documents"),                                 
            optparse.make_option("--with-md-docs",
                                 dest="with_md",
                                 action="store_true",
                                 help="Generate markdown(.md) RESTCONF API documents"),                    
        ]
        g = optparser.add_option_group("OpenApiV3Plugin options")
