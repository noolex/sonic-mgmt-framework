...
func Test_FieldExpntVal_OCYang(t *testing.T) {
	...
	/** Field Exponent value processing get**/
        prereq_map = map[string]interface{}{"BGP_GLOBALS":map[string]interface{}{"Vrf_test1":map[string]interface{}{
                                                                                 "confed_peers@": "4294,1,429"}},
					     "VRF":map[string]interface{}{"Vrf_test1":map[string]interface{}{
                                                                                                  "NULL": "NULL"}}}
        loadConfigDB(rclient, prereq_map)
        expected_get_json := "{\"openconfig-network-instance:member-as\":[4294,1,429]}"
...
func Test_FieldExpntVal_SonicYang(t *testing.T) {
	...
	/** Field Exponent value processing replace**/
        ...
        expected_map = map[string]interface{}{"BGP_GLOBALS":map[string]interface{}{"Vrf_test1":map[string]interface{}{
                                                                                                  ...
                                                                                                  "confed_peers@": "4294967294,1,4294967295"}}}
        loadConfigDB(rclient, prereq_map)
	url = "/sonic-bgp-global:sonic-bgp-global/BGP_GLOBALS/BGP_GLOBALS_LIST[vrf_name=Vrf_test1]/local_asn"
        url_body_json = "{\"sonic-bgp-global:local_asn\":4294967291}"
        t.Run("Field Exponent value replace.", processSetRequest(url, url_body_json, "PUT", false, nil))
        time.Sleep(1 * time.Second)
        t.Run("Verify Field Exponent value replace.", verifyDbResult(rclient, "BGP_GLOBALS|Vrf_test1", expected_map, false))
        unloadConfigDB(rclient, prereq_map)
        ...
        prereq_map = map[string]interface{}{"BGP_GLOBALS":map[string]interface{}{"Vrf_test1":map[string]interface{}{
					     ...
					     "VRF":map[string]interface{}{"Vrf_test1":map[string]interface{}{
                                                                                                  "NULL": "NULL"}}}
        loadConfigDB(rclient, prereq_map)
        expected_get_json := "{\"sonic-bgp-global:BGP_GLOBALS_LIST\":[{\"always_compare_med\":false,\"confed_peers\":[4294967294,1,4294967295],\"keepalive\":123,\"local_asn\":4294967293,\"vrf_name\":\"Vrf_test1\"}]}"
        t.Run("Field Exponent value get.", processGetRequest(url, expected_get_json, false))
        time.Sleep(1 * time.Second)
        unloadConfigDB(rclient, prereq_map)
        /*********************/
...
func Test_KeyExpntVal_OCYang(t *testing.T) {
        ...
        bgp_globals_map := map[string]interface{}{"BGP_GLOBALS":map[string]interface{}{"Vrf_test1":map[string]interface{}{
					     ...
					     "VRF":map[string]interface{}{"Vrf_test1":map[string]interface{}{
                                                                                                  "NULL": "NULL"}}}
        bgp_globals_af_map := map[string]interface{}{"BGP_GLOBALS_AF":map[string]interface{}{"Vrf_test|l2vpn_evpn":map[string]interface{}{
                                                                                                  "NULL": "NULL"}}}
        bgp_globals_evpnvni_map := map[string]interface{}{"BGP_GLOBALS_EVPN_VNI":map[string]interface{}{"Vrf_test|L2VPN_EVPN|14628525":map[string]interface{}{
	...
	url = "/openconfig-network-instance:network-instances/network-instance[name=Vrf_test]/protocols/protocol[identifier=BGP][name=bgp]/bgp/global/afi-safis/afi-safi[afi-safi-name=L2VPN_EVPN]/l2vpn-evpn/openconfig-bgp-evpn-ext:vnis/vni[vni-number=14628525]"
        ...
        time.Sleep(1 * time.Second)
        t.Run("Verify Key Exponent value create - BGP_GLOBALS_AF.", verifyDbResult(rclient, "BGP_GLOBALS_AF|Vrf_test|l2vpn_evpn", bgp_globals_af_map, false))
        t.Run("Verify Key Exponent value create - BGP_GLOBALS_EVPN_VNI.", verifyDbResult(rclient, "BGP_GLOBALS_EVPN_VNI|Vrf_test|L2VPN_EVPN|14628525", bgp_globals_evpnvni_map, false))
	...
	url = "/openconfig-network-instance:network-instances/network-instance[name=Vrf_test1]/protocols/protocol[identifier=BGP][name=bgp]/bgp/global/afi-safis/afi-safi[afi-safi-name=L2VPN_EVPN]/l2vpn-evpn/openconfig-bgp-evpn-ext:vnis/vni[vni-number=14628525]/advertise-default-gw"
        ...
        time.Sleep(1 * time.Second)
        t.Run("Verify Key Exponent value update - BGP_GLOBALS_EVPN_VNI.", verifyDbResult(rclient, "BGP_GLOBALS_EVPN_VNI|Vrf_test1|L2VPN_EVPN|14628525", bgp_globals_evpnvni_map, false))
        unloadConfigDB(rclient, bgp_globals_map)
        unloadConfigDB(rclient, bgp_globals_af_map)
        unloadConfigDB(rclient, bgp_globals_evpnvni_map)
        /*********************/
	...
	/** Key Exponent value processing replace**/
        ...
        time.Sleep(1 * time.Second)
        t.Run("Verify Key Exponent value replace - BGP_GLOBALS_EVPN_VNI.", verifyDbResult(rclient, "BGP_GLOBALS_EVPN_VNI|Vrf_test1|L2VPN_EVPN|14628525", bgp_globals_evpnvni_map, false))
        unloadConfigDB(rclient, bgp_globals_map)
        unloadConfigDB(rclient, bgp_globals_af_map)
        unloadConfigDB(rclient, bgp_globals_evpnvni_map)
        /*********************/
	...
	/** Key Exponent value  processing delete**/
        ...
        loadConfigDB(rclient, bgp_globals_af_map)
        loadConfigDB(rclient, bgp_globals_evpnvni_map)
        url = "/openconfig-network-instance:network-instances/network-instance[name=Vrf_test1]/protocols/protocol[identifier=BGP][name=bgp]/bgp/global/afi-safis/afi-safi[afi-safi-name=L2VPN_EVPN]/l2vpn-evpn/openconfig-bgp-evpn-ext:vnis/vni[vni-number=14628]"
