...
def invoke_api(func, args):
    ...
    if func == 'patch_bgp_evpn_advertise_default_gw':
        keypath = cc.Path('/restconf/data/openconfig-network-instance:network-instances/network-instance={vrf}'
            +'/protocols/protocol=BGP,bgp/bgp/global/afi-safis/afi-safi={af_name}/l2vpn-evpn/openconfig-bgp-evpn-ext:config'
        ...
        return api.patch(keypath, body)
    if func == 'patch_bgp_evpn_advertise_svi_ip':
        keypath = cc.Path('/restconf/data/openconfig-network-instance:network-instances/network-instance={vrf}'
            +'/protocols/protocol=BGP,bgp/bgp/global/afi-safis/afi-safi={af_name}/l2vpn-evpn/openconfig-bgp-evpn-ext:config'
            +'/advertise-svi-ip',
                vrf=args[0], af_name=args[1])
        ...
        return api.patch(keypath, body)
    if func == 'patch_bgp_evpn_default_originate':
        keypath = cc.Path('/restconf/data/openconfig-network-instance:network-instances/network-instance={vrf}'
    ...
    if func == 'patch_bgp_evpn_rt':
        ...
        if rttype == 'both' or rttype == 'export':
            ...
            response = api.patch(keypath, body)
        return response
    if func == 'patch_bgp_evpn_advertise':
        keypath = cc.Path('/restconf/data/openconfig-network-instance:network-instances/network-instance={vrf}'
            +'/protocols/protocol=BGP,bgp/bgp/global/afi-safis/afi-safi={af_name}/l2vpn-evpn/openconfig-bgp-evpn-ext:config'
            +'/advertise-list',
                vrf=args[0], af_name=args[1])
    ...
    if func == 'patch_bgp_evpn_autort':
        ...
        return api.patch(keypath, body)
    if func == 'patch_bgp_evpn_flooding':
        keypath = cc.Path('/restconf/data/openconfig-network-instance:network-instances/network-instance={vrf}'
            +'/protocols/protocol=BGP,bgp/bgp/global/afi-safis/afi-safi={af_name}/l2vpn-evpn'
        ...
        return api.patch(keypath, body)
    if func == 'patch_bgp_evpn_dad_enable_params':
        if len(args) < 3:
            keypath = cc.Path('/restconf/data/openconfig-network-instance:network-instances/network-instance={vrf}'
                +'/protocols/protocol=BGP,bgp/bgp/global/afi-safis/afi-safi={af_name}/l2vpn-evpn'
            ...
            return api.patch(keypath, body)
    if func == 'patch_bgp_evpn_dad_freeze':
        if args[2] == 'permanent':
            keypath = cc.Path('/restconf/data/openconfig-network-instance:network-instances/network-instance={vrf}'
                +'/protocols/protocol=BGP,bgp/bgp/global/afi-safis/afi-safi={af_name}/l2vpn-evpn'
    ...
    if func == 'patch_bgp_evpn_vni_rt':
        ...
        if rttype == 'both' or rttype == 'export':
            ...
            response = api.patch(keypath, body)
        return response
    if func == 'patch_bgp_evpn_vni_advertise_default_gw':
        keypath = cc.Path('/restconf/data/openconfig-network-instance:network-instances/network-instance={vrf}'
            +'/protocols/protocol=BGP,bgp/bgp/global/afi-safis/afi-safi={af_name}/l2vpn-evpn'
        ...
        return api.patch(keypath, body)
    if func == 'patch_bgp_evpn_vni_advertise_svi_ip':
        keypath = cc.Path('/restconf/data/openconfig-network-instance:network-instances/network-instance={vrf}'
            +'/protocols/protocol=BGP,bgp/bgp/global/afi-safis/afi-safi={af_name}/l2vpn-evpn'
    ...
    #PIP cases
    if func == 'patch_bgp_evpn_advertise_pip':
        ...
        if 'enable' not in list(arg_map.keys()) :
    ...
    #Delete cases
    if func == 'delete_bgp_evpn_advertise_all_vni':
        keypath = cc.Path('/restconf/data/openconfig-network-instance:network-instances/network-instance={vrf}'
            +'/protocols/protocol=BGP,bgp/bgp/global/afi-safis/afi-safi={af_name}/l2vpn-evpn'
            +'/openconfig-bgp-evpn-ext:config/advertise-all-vni',
                vrf=args[0], af_name=args[1])
        return api.delete(keypath)
    if func == 'delete_bgp_evpn_advertise_default_gw':
        keypath = cc.Path('/restconf/data/openconfig-network-instance:network-instances/network-instance={vrf}'
            +'/protocols/protocol=BGP,bgp/bgp/global/afi-safis/afi-safi={af_name}/l2vpn-evpn'
            +'/openconfig-bgp-evpn-ext:config/advertise-default-gw',
                vrf=args[0], af_name=args[1])
        return api.delete(keypath)
    if func == 'delete_bgp_evpn_advertise_svi_ip':
        keypath = cc.Path('/restconf/data/openconfig-network-instance:network-instances/network-instance={vrf}'
            +'/protocols/protocol=BGP,bgp/bgp/global/afi-safis/afi-safi={af_name}/l2vpn-evpn'
            +'/openconfig-bgp-evpn-ext:config/advertise-svi-ip',
                vrf=args[0], af_name=args[1])
        return api.delete(keypath)
    if func == 'delete_bgp_evpn_default_originate':
        keypath = cc.Path('/restconf/data/openconfig-network-instance:network-instances/network-instance={vrf}'
            +'/protocols/protocol=BGP,bgp/bgp/global/afi-safis/afi-safi={af_name}/l2vpn-evpn'
            +'/openconfig-bgp-evpn-ext:default-originate/config/{originate_family}',
                vrf=args[0], af_name=args[1], originate_family=args[2])
        return api.delete(keypath)
    if func == 'delete_bgp_evpn_rd':
        keypath = cc.Path('/restconf/data/openconfig-network-instance:network-instances/network-instance={vrf}'
            +'/protocols/protocol=BGP,bgp/bgp/global/afi-safis/afi-safi={af_name}/l2vpn-evpn'
            +'/openconfig-bgp-evpn-ext:config/route-distinguisher',
                vrf=args[0], af_name=args[1])
        return api.delete(keypath)
    if func == 'delete_bgp_evpn_rt':
        rttype = args[3]
        if rttype == "both" or rttype == "import":
            keypath = cc.Path('/restconf/data/openconfig-network-instance:network-instances/network-instance={vrf}'
                +'/protocols/protocol=BGP,bgp/bgp/global/afi-safis/afi-safi={af_name}/l2vpn-evpn'
        ...
        if len(args) < 3:
            ...
            keypath = cc.Path('/restconf/data/openconfig-network-instance:network-instances/network-instance={vrf}'
                ...
                +'/openconfig-bgp-evpn-ext:dup-addr-detection/config/time',
                    vrf=args[0], af_name=args[1])
            return api.delete(keypath)
    if func == 'delete_bgp_evpn_dad_freeze':
        keypath = cc.Path('/restconf/data/openconfig-network-instance:network-instances/network-instance={vrf}'
            +'/protocols/protocol=BGP,bgp/bgp/global/afi-safis/afi-safi={af_name}/l2vpn-evpn'
            +'/openconfig-bgp-evpn-ext:dup-addr-detection/config/freeze',
                vrf=args[0], af_name=args[1])
    ...
    if func == 'delete_bgp_evpn_vni':
        keypath = cc.Path('/restconf/data/openconfig-network-instance:network-instances/network-instance={vrf}'
            +'/protocols/protocol=BGP,bgp/bgp/global/afi-safis/afi-safi={af_name}/l2vpn-evpn'
            +'/openconfig-bgp-evpn-ext:vnis/vni={vni_number}',
                vrf=args[0], af_name=args[1], vni_number=args[2])
        return api.delete(keypath)
    if func == 'delete_bgp_evpn_vni_rt':
        rttype = args[4]
        if rttype == "both" or rttype == "import":
            keypath = cc.Path('/restconf/data/openconfig-network-instance:network-instances/network-instance={vrf}'
                +'/protocols/protocol=BGP,bgp/bgp/global/afi-safis/afi-safi={af_name}/l2vpn-evpn'
        ...
        if rttype == "both" or rttype == "export":
            ...
            response = api.delete(keypath)
        return response
    if func == 'delete_bgp_evpn_vni_advertise_default_gw':
        keypath = cc.Path('/restconf/data/openconfig-network-instance:network-instances/network-instance={vrf}'
            +'/protocols/protocol=BGP,bgp/bgp/global/afi-safis/afi-safi={af_name}/l2vpn-evpn'
            +'/openconfig-bgp-evpn-ext:vnis/vni={vni_number}/config/advertise-default-gw',
                vrf=args[0], af_name=args[1], vni_number=args[2])
        return api.delete(keypath)
    if func == 'delete_bgp_evpn_vni_advertise_svi_ip':
        keypath = cc.Path('/restconf/data/openconfig-network-instance:network-instances/network-instance={vrf}'
            +'/protocols/protocol=BGP,bgp/bgp/global/afi-safis/afi-safi={af_name}/l2vpn-evpn'
            +'/openconfig-bgp-evpn-ext:vnis/vni={vni_number}/config/advertise-svi-ip',
                vrf=args[0], af_name=args[1], vni_number=args[2])
        return api.delete(keypath)
    if func == 'delete_bgp_evpn_vni_rd':
        keypath = cc.Path('/restconf/data/openconfig-network-instance:network-instances/network-instance={vrf}'
            +'/protocols/protocol=BGP,bgp/bgp/global/afi-safis/afi-safi={af_name}/l2vpn-evpn'
            +'/openconfig-bgp-evpn-ext:vnis/vni={vni_number}/config/route-distinguisher',
                vrf=args[0], af_name=args[1], vni_number=args[2])
    ...
    #Delete PIP cases
    if func == 'delete_bgp_evpn_advertise_pip':
        #fetch parameter values
